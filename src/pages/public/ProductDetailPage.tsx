  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <PageHeader
        ...
        subtitle={`${activeProduct.brand} | SKU: ${activeProduct.sku} | Category: ${activeProduct.category}`}
        breadcrumbs={[
          { label: 'Catalog', href: '/products' },
          { label: activeProduct.category, href: `/products?category=${encodeURIComponent(activeProduct.category)}` },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-7 space-y-6">
          ...
          <Card title="Product Description & Technical Specifications" className="border-slate-200">
            <p className="text-sm text-slate-700 leading-relaxed mb-6">{activeProduct.description}</p>
